---
title: Targets
description: webpack의 Targets 개념과 동작 방식을 설명합니다.
sort: 10
contributors:
  - TheLarkInn
  - rouzbeh84
...
webpack은 `target` 프로퍼티에 [문자열 배열](/configuration/target/#string)을 전달하는 것을 지원합니다. 이 경우 해당 기능들의 공통 부분집합이 사용됩니다. 이를 통해 여러 환경에서 실행되는 범용 코드를 빌드할 수 있습니다. 예를 들어 `web`과 `node`를 결합할 수 있습니다.
