...
T> 이 설정을 단일 페이지 애플리케이션용 [HtmlWebpackPlugin](/plugins/html-webpack-plugin/) 또는 멀티 페이지 애플리케이션용 [ChunksWebpackPlugin](https://github.com/yoriiis/chunks-webpack-plugin?tab=readme-ov-file#chunkswebpackplugin)과 결합할 수 있습니다. 이는 생성 된 모든 vendor 청크를 주입합니다.
...
`splitChunks.name`이 [엔트리 포인트](/configuration/entry-context/#entry)이름과 일치하면 엔트리 포인트 청크 및 캐시 그룹이 단일 청크로 결합됩니다.
