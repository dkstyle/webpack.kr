...
T> 목록을 조정할 때 [`performance.unusedExternals`](/configuration/performance/#performanceunusedexternals)를 활성화하세요. 어떤 모듈도 가져오지 않은 `externals` 요청을 보고하므로 철자가 틀린 allowlist 항목을 찾을 수 있습니다.
