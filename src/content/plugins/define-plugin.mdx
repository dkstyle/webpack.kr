---
title: DefinePlugin
description: DefinePlugin의 기능과 사용 방법을 설명합니다.
group: webpack
contributors:
  - simon04
  - rouzbeh84
...
- 첫 번째 인자는 위의 제너레이터 함수입니다. `{ module, key, version }`을 받아 정의에 할당할 값을 반환합니다.
- 두 번째 인자는 감시할 파일 경로의 배열이거나 모듈을 캐시 할 수 없음으로 표시하는 `true` 플래그일 수 있습니다. 5.26.0 버전부터는 아래의 속성을 가진 객체 인자를 사용할 수 있습니다.
  ...
  - `buildDependencies?: string[]` 함수가 의존하는 빌드 디펜던시 목록입니다.
