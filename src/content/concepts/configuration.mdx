---
title: Configuration
description: webpack의 Configuration 개념과 동작 방식을 설명합니다.
sort: 5
contributors:
  - TheLarkInn
  - simon04
...
Webpack은 여러 개의 설정 객체를 내보내는 것을 지원하며, 이는 서로 다른 대상이나 출력물을 빌드할 때(예: 클라이언트 번들과 서버 번들을 분리할 때) 유용할 수 있습니다.

대부분의 프로젝트에서는 하나의 설정 객체로도 충분하지만, 여러 개의 설정 객체를 사용하면 더 복잡한 설정을 체계적으로 관리할 수 있습니다.
