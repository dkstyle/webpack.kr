...
- `debugIds` (`boolean`): `true`이면 소스 및 소스맵에서 고유한 ID를 발행하여 여러 빌드에서 소스 맵을 식별하는 것이 간소화됩니다. 자세한 내용은 [TC39 소스맵 디버깅 ID 제안서](https://github.com/tc39/ecma426/blob/main/proposals/debug-id.md)를 참고하세요.
