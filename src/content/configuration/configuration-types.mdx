...
description: webpack의 Configuration Types 설정과 사용 방법을 설명합니다.
sort: 3
contributors:
  - sokra
  - skipjack
...
다른 설정의 출력에 의존하는 설정이 있는 경우 [`dependencies`](/configuration/other-options/#dependencies) 배열을 사용하여 의존성 목록을 지정할 수 있습니다.
