...
description: webpack 로고, 색상, 타이포그래피와 사용 규칙을 설명합니다.
sort: 2
contributors:
  - jhnns
  - skipjack
...
<img
  ...
  alt="밝은 배경에서 적절한 여백을 둔 기본 webpack 로고"
/>
...
T> 가이드라인을 따르고 여기까지 온 분들을 위해, 커스텀 이모지(slack이나 gitter 채널 같은 ;))로 사용할 수 있는 더 작은 크기의 이미지를 만들었습니다.
