---
title: Stats Data
description: Stats Data API의 기능과 사용 방법을 설명합니다.
sort: 3
contributors:
  - skipjack
  - franjohn21
...
```json
{
  ...
  "request": "./lib/index.web.js" // 청크 그룹을 생성한 요청
}
```
...
```json
{
  ...
  "built": true, // 이번 컴파일에서 모듈이 빌드([로더](/concepts/loaders) 및 파싱)되었음을 의미
  "cacheable": true, // 모듈이 캐시 가능한지 여부
  "chunks": [
    // 모듈을 포함하는 청크 ID
  ],
  "codeGenerated": true, // 이번 컴파일에서 모듈이 코드 생성을 거쳤음을 의미
