---
title: Web Workers
description: webpack에서 Web Workers을 사용하는 방법을 설명합니다.
sort: 21
contributors:
  - chenxsan
translators:
...
> 참고: 이는 고급 사용 사례입니다. 워커가 추가 청크를 로드하지 않거나 자산이 정적 동일 출처 경로에서 제공되는 경우 일반적으로 `__webpack_public_path__`를 수동으로 설정할 필요가 없습니다.
