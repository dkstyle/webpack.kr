---
title: Output
description: webpack의 Output 개념과 동작 방식을 설명합니다.
sort: 2
contributors:
  - TheLarkInn
  - chyipin
...
설정에서 하나 이상의 "청크"를 생성하면(다중 엔트리 포인트나 [`optimization.splitChunks`](/configuration/optimization/#optimizationsplitchunks), `SplitChunksPlugin`을 사용하는 경우), 각 파일이 고유한 이름을 갖도록 [substitution](/configuration/output/#outputfilename)을 사용해야 합니다.
