...
description: webpack에서 Advanced entry을 사용하는 방법을 설명합니다.
sort: 25
contributors:
  - EugeneHlushko
translators:
...
Webpack은 CSS를 자체적으로 추출하므로 `sass-loader`만 필요합니다. 규칙에 [CSS module 타입](/guides/native-css/#css-module-types)을 지정하면 나머지는 webpack이 처리합니다.
